...
<article>"Movies can be an art<br>Let yourself be carried away"</article>
         ...
         <div class="filmPopular">
             ...
             <div class="sliderFilmPopulaire">
                 <?php foreach ($movies['results'] as $key => $film) : ?>
                        <figure>
                        <a href="singleFilm/<?= $film['id'] ?>"><img src="https://image.tmdb.org/t/p/w500<?= $film['poster_path'] ?>" alt="<?= $film['title'] ?>" class="posterPopularFilm">
         ...
         <div class="filmPopular">
             ...
             <div class="sliderFilmPopulaire">
                 <?php foreach ($series['results']  as $key => $serie) : ?>
                    <figure>
                       <a href="../Series/singleSerie/<?= $serie['id'] ?>"><img src="https://image.tmdb.org/t/p/w500<?= $serie['poster_path'] ?>" alt="<= $serie['name'] ?>" class="posterPopularFilm">
